...
This analysis was completed against [WA DNR hydrography](../distance-to-waterways--wa-dnr/), but we found that the number of streams that were of `Unknown` period to didn't assist in proving or disproving this hypothesis. The same analysis is carried out using WA NDH data below.
