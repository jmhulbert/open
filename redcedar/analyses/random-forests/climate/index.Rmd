...
Generally, removing dead trees may make the most sense biologically, because we're not sure about the cause of the dead tree. Later we could test if there is a good climate variable for classifiny trees as alive or dead. 
...
seaonal <- seasonal %>% filter(reclassified.tree.canopy.symptoms!="Tree is Dead") %>% droplevels()
...
Explore if monthly, seaonal, or annual data are best fit for binomial distributed glmm. 
